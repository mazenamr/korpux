...
public class Constants {
    ...
    public static final String DOCUMENT_DB_NAME = "document-db";
    ...
    public static final HashSet<String> STOP_WORDS_STEMMED = new HashSet<>();

    static {
        PorterStemmer stemmer = new PorterStemmer();
        for (String word : STOP_WORDS_NOT_STEMMED) {
            STOP_WORDS_STEMMED.add(stemmer.stem(word));
        }
    }
}
